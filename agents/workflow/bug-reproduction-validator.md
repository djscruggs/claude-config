...
description: "Validates whether a reported issue is an actual bug by systematically reproducing it. Classifies as: Confirmed Bug, Cannot Reproduce, Not a Bug, Environmental Issue, or User Error. Use before spending time on a fix."
model: inherit
---
