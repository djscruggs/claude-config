...
description: "Analyzes specs, plans, and feature descriptions to map all user flows, identify edge cases, and surface gaps before implementation begins. Use proactively when presented with any feature specification or when you need to find what is missing."
model: inherit
---
