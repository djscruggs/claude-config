...
description: "Addresses PR review comments by implementing the requested change and producing a resolution report. Handles the full workflow: understand → plan → implement → verify → summarize. Use when working through code review feedback."
color: blue
model: inherit
---
