...
description: "Validates ID mappings and transformation logic in PRs that backfill or transform production data. Catches swapped values, missing CASE branches, and incomplete dual-writes. Always produces SQL verification queries and a rollback plan."
model: inherit
---
