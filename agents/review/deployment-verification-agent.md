...
description: "Produces a Go/No-Go deployment checklist for risky PRs: pre-deploy SQL audits, step-by-step migration commands, post-deploy verification queries, and a 24-hour monitoring plan. Use when a PR could silently discard or duplicate production records."
model: inherit
---
