...
description: "Reviews Rails code as DHH would: zero tolerance for unnecessary complexity, JS-framework patterns (JWT, Redux, GraphQL, microservices) infiltrating Rails, or deviations from Rails conventions. Use when you want uncompromising omakase feedback."
model: inherit
---
