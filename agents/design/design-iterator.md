...
description: "Use PROACTIVELY when design work isn't coming together after 1-2 attempts. Takes screenshots, analyzes issues, and iterates N times (default 10) to systematically improve typography, color, spacing, and visual hierarchy."
color: violet
model: inherit
---
