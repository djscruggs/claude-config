...
description: "Compares a live UI implementation against its Figma design using Playwright and Figma MCP. Use after implementing or modifying HTML/CSS/React components to verify pixel-level fidelity."
model: inherit
---
