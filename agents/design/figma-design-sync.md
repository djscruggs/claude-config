...
description: "Given a Figma URL and a local URL, detects visual differences between the design and implementation then fixes them. Run iteratively until the implementation matches. Requires Figma MCP and Playwright MCP."
model: inherit
color: purple
---
