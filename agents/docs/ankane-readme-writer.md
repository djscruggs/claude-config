...
description: "Creates or rewrites Ruby gem README files following the Ankane style: imperative voice, sentences ≤15 words, standard section order (Installation, Quick Start, Usage, Options, Upgrading, Contributing, License)."
color: cyan
model: inherit
---
